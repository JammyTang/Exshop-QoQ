...
1. create a folder named "exshop" on your cloud drive,then create a folder named "QoQ" in it,
   Finally, create two folders named "raw_data" and "data".

2. Click on the upper right corner of "Exshop QoQ_analytics" and select "More Actions" -> "Create Copy".
   Place a copy of the created file in the QoQ folder
